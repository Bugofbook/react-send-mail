...
const RenderItem = ({
  ...
  return <button onClick={onCreateMail}>click Me</button>
}
...
const RenderItem2 = ({
  ...
  return <button onClick={onCreateMail}>{`click Me,mailTo:${mailTo}`}</button>
}

const Template: ComponentStory<typeof MailComponent> = (args) => (
  <MailComponent {...args} />
)
